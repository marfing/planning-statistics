 ...
 */
final class Version20180904123224 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE traffic_report (id INT AUTO_INCREMENT NOT NULL, router_in_id INT NOT NULL, router_out_id INT NOT NULL, router_in_name VARCHAR(255) DEFAULT NULL, router_in_ip INT NOT NULL, router_out_name VARCHAR(255) DEFAULT NULL, router_out_ip INT NOT NULL, bandwidth INT DEFAULT NULL, last_timestamp DATETIME NOT NULL, INDEX IDX_216B5BA35583B2E (router_in_id), INDEX IDX_216B5BA3671C95E6 (router_out_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE router (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, ip_address INT NOT NULL, file_system_root_path VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
